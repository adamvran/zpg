...
vec4 pointLight(PointLight light, vec3 world_normal, vec4 world_position, vec3 viewDirection, vec4 ambient)
{
...
vec4 directionalLight(DirectionalLight light, vec3 world_normal, vec4 world_position, vec3 viewDirection, vec4 ambient)
{
...
/*vec4 spotLight(Light light, vec3 world_normal, vec4 world_position, vec3 viewDirection, vec4 ambient)
{
	vec3 lightDirection = count_lightDirection(light.position, world_position);
...
vec4 spotLight(SpotLight light, vec3 world_normal, vec4 world_position, vec3 viewDirection, vec4 ambient, vec3 camera)
{
...
void main() {
	...
	{
		fragmentColor += pointLight(pointLights[i], world_normal, ex_worldPosition, viewDirection, ambient);
	}
