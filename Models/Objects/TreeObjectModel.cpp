#include "TreeObjectModel.h"

TreeObjectModel::TreeObjectModel()
{
...
void TreeObjectModel::createVBO()
{
...
void TreeObjectModel::createVAO()
{
...
void TreeObjectModel::drawObject()
{
    glBindVertexArray(this->VAO);
    glDrawArrays(this->objectType, 0, this->countOfVertex);
}

void TreeObjectModel::initPositionAndColor()
{
