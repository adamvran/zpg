#include "HouseObjectModel.h"

HouseObjectModel::HouseObjectModel()
{
...
void HouseObjectModel::createVBO()
{
...
void HouseObjectModel::createVAO()
{
...
void HouseObjectModel::drawObject()
{
    glBindVertexArray(this->VAO);
    glDrawArrays(this->objectType, 0, this->countOfVertex);
}

void HouseObjectModel::initPositionAndColor()
{
