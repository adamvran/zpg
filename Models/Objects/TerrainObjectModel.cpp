#include "TerrainObjectModel.h"

TerrainObjectModel::TerrainObjectModel()
{
...
void TerrainObjectModel::createVBO()
{
...
void TerrainObjectModel::createVAO()
{
...
void TerrainObjectModel::drawObject()
{
    glBindVertexArray(this->VAO);
    glDrawArrays(this->objectType, 0, this->countOfVertex);
}

void TerrainObjectModel::initPositionAndColor()
{
